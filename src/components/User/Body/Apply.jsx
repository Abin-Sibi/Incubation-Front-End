      ...
      {getApp !== true ? (
        <>
          <div className="centerDiv">
            ...
            {
              selectedApplication.isApproved? <p>Status: <span style={{color:'green'}}>Approved</span></p>:<p>Status: <span style={{color:'green'}}>Requested</span></p>
            }
        ...
        <div className="centerDiv">
          <button className="btnapply"><NavLink className="navapply" to={"/apply"}>Apply </NavLink></button>
        </div>
      )}
      <div
        class="modal fade"
